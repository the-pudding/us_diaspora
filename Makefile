...
aws-assets:
	aws s3 sync dist s3://pudding.cool/2020/01/diaspora --delete --cache-control 'max-age=31536000' --exclude 'index.html' --exclude 'main.js'

aws-htmljs:
	aws s3 cp dist/index.html s3://pudding.cool/2020/01/diaspora/index.html
